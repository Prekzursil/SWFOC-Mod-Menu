...
See also: [Lua API](lua-api.md) | [Struct Reference](index.md)
...
| `0x3ABB80` | Make_Invulnerable_Setter | CONFIRMED-RE | Phase 2 RE, propagates to hardpoints |
...
| `0x4052D0` | GetHardpoint | DISCOVERED-GHIDRA | Returns hardpoint by index |
| `0x405300` | HardpointCount | DISCOVERED-GHIDRA | Returns number of hardpoints |
