# SWFOC Lua API Reference

This page documents all 405 Lua functions available in Star Wars: Empire at War -- Forces of Corruption.

See also: [RVA Table](rvas.md) | [Struct Reference](../index.md)
