...
public abstract class MainViewModelCoreStateBase : INotifyPropertyChanged
{
    ...
    protected const string PayloadSymbol = MainViewModelDefaults.PayloadSymbol;
    protected const string PayloadIntValue = MainViewModelDefaults.PayloadIntValue;
    protected const string PayloadBoolValue = MainViewModelDefaults.PayloadBoolValue;
    protected const string PayloadEnable = MainViewModelDefaults.PayloadEnable;
    protected const string PayloadFloatValue = MainViewModelDefaults.PayloadFloatValue;
    protected const string PayloadFreeze = MainViewModelDefaults.PayloadFreeze;
    protected const string PayloadLockCredits = MainViewModelDefaults.PayloadLockCredits;
