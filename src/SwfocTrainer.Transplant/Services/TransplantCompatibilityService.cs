...
public sealed class TransplantCompatibilityService : ITransplantCompatibilityService
{
        ...
        IReadOnlySet<string> activeWorkshopIds)
    {
        ...
        var requiresTransplant = !string.IsNullOrWhiteSpace(sourceWorkshopId) && !activeWorkshopIds.Contains(sourceWorkshopId);
        ...
        var dependencies = entity.DependencyRefs is null
            ? Array.Empty<string>()
            : entity.DependencyRefs
